...
func (r *MockSecretRepository) CreateSecret(content string) (string, error) {
	return "727d7040-aac7-4dc3-ab44-938bfba92ebd", nil
}

func (r *MockSecretRepository) UpdateToViewed(id string) error {
	return nil
}
